...
export class ReviewsController {
  ...
  @ApiParam({ name: 'id', description: 'Review CUID', example: 'clx1abc2300001' })
  ...
  @ApiParam({ name: 'userId', description: 'User CUID', example: 'clx1abc2300001' })
  @ApiOkResponse({ type: [Review], description: 'Array of reviews by the user' })
  @Get('user/:userId')
  ...
  @ApiParam({ name: 'productId', description: 'Product CUID', example: 'clx1abc2300001' })
  @ApiOkResponse({ type: [Review], description: 'Array of reviews for the product' })
